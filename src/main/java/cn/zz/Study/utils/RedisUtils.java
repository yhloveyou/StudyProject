...
public final class RedisUtils {
    ...
    public static void del(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                that.delete((Collection<String>) CollectionUtils.arrayToList(key));
            }
        }
    }
    ...
    public static Object get(String key) {
        return key == null ? null : that.opsForValue().get(key);
    }
    ...
    public static boolean set(String key, Object value) {
        try {
            that.opsForValue().set(key, value);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
    ...
    public static Long incr(String key, Long delta) {
        ...
        return that.opsForValue().increment(key, delta);
    }
    ...
    public static Object hget(String key, String item) {
        return that.opsForHash().get(key, item);
    }
    ...
    public static Map<Object, Object> hmget(String key) {
        return that.opsForHash().entries(key);
    }
    ...
    public static void hdel(String key, Object... item) {
        that.opsForHash().delete(key, item);
    }
    ...
    public static boolean hHasKey(String key, String item) {
        return that.opsForHash().hasKey(key, item);
    }
    ...
    public static double hincr(String key, String item, double by) {
        return that.opsForHash().increment(key, item, by);
    }
    ...
    public static Set<Object> sGet(String key) {
        try {
            return that.opsForSet().members(key);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean sHasKey(String key, Object value) {
        try {
            return that.opsForSet().isMember(key, value);
        } catch (Exception e) {
            e.printStackTrace();
            return false;
        }
